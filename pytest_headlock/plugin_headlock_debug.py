...
class CMakeToolChain(ToolChainDriver):
    ...
    def exe_path(self, build_dir, name):
        return self.base_toolchain.exe_path(build_dir, name)
    ...
    def generate_cmakelists(self, transunits, build_dir, prj_name):
    ...
    def build(self, transunits, build_dir, name):
        self.base_toolchain.build(transunits, build_dir, name)
        cmakelists_path = build_dir / 'CMakeLists.txt'
        cmakelists_content = ''.join(
            self.generate_cmakelists(transunits, build_dir, name))
